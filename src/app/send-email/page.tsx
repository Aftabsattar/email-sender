...
export default function Sun() {
  ...
  return (
    <div className="container px-52 flex flex-col justify-center items-center w-96 space-y-4 mx-auto mt-52 p-10 rounded-xl bg-zinc-300">
      {/* Header Section */}
      <div className="flex items-center justify-center space-x-5">
        <h2 className="text-2xl italic">To</h2>
        ...
        <input
          ...
          className="bg-white w-80 min-h-7 pl-8 outline-none rounded"
        />
